...
const adorsholipi = localFont({
  src: [
    { path: "../public/fonts/Adorsholipi-Regular.woff2", weight: "400", style: "normal" },
    { path: "../public/fonts/Adorsholipi-Medium.woff2",  weight: "500", style: "normal" },
    { path: "../public/fonts/Adorsholipi-SemiBold.woff2", weight: "600", style: "normal" },
    { path: "../public/fonts/Adorsholipi-Bold.woff2",   weight: "700", style: "normal" },
  ],
